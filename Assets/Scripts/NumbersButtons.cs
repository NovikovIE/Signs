...
public class NumbersButtons : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        {
            switch_to_blue();
            GameObject.Find("EventSystem").GetComponent<ButtonControllerNumbers>().current_green_button = -1;
        }
        else
        {
            GameObject.Find("EventSystem").GetComponent<ButtonControllerNumbers>().make_other_blue(number);
            switch_to_green();
        }
    }
